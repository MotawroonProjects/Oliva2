...
public interface DAOInterface {
    ...
    long[] insertRetrieveData(List<ProductModel> retrieveModel);
    @Insert(entity = CategoryModel.class, onConflict = OnConflictStrategy.IGNORE)
    long[] insertCategoryData(List<CategoryModel> categoryModelList);
    @Query("SELECT * FROM "+ Tags.table_category)
    List<CategoryModel> getCategory();
    @Query("SELECT * FROM "+ Tags.table_products+" where featured=:id")
    List<ProductModel> getProductByFeatured(String id);
    @Query("SELECT * FROM "+ Tags.table_products+" where category_id=:id")
    List<ProductModel> getProductByCategory(String id);
    @Query("SELECT * FROM "+ Tags.table_products+" where brand_id=:id")
    List<ProductModel> getProductByBrand(String id);
    ...
    long[] insertBrandData(List<BrandModel> brandModelList);
